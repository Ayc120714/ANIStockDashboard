...
describe('livePageCacheKeys', () => {
  it('exposes stable keys for live-market page cache policy', () => {
    ...
    expect(LIVE_PAGE_CACHE_KEYS.stageEntryTiming).toBe('advisor_stage_entry_timing_v4');
    expect(LIVE_PAGE_CACHE_KEYS.compressionBreakout('1d')).toBe('advisor_compression_breakout_v1_1d');
  });
