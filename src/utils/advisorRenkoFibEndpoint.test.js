/**
 * Guard: Renko Smart tab must load the 44-50 fib-zone pullback flow,
 * not the older ST-flip-only endpoint.
 */
describe('advisor Renko fib-zone data source', () => {
  ...
  it('keeps display columns limited to Symbol CMP T1 T2 SL', () => {
    ...
    expect(cols).not.toContain('rs_daily_123');
  });
});
