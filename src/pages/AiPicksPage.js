                  ...
                  <tr key={r.symbol}>
                    ...
                    <td style={compact}>
                      <Box sx={{ display: 'flex', gap: 0.3 }}>
                        <Tooltip title={added[shortKey] ? 'Added' : 'Short Term'}>
                          <span>
                            <IconButton size="small" disabled={!!added[shortKey]}
                              onClick={() => handleAdd(r.symbol, 'short_term')}
                              sx={{ p: '2px', bgcolor: added[shortKey] ? '#e8f5e9' : '#e3f2fd',
                                color: added[shortKey] ? '#2e7d32' : '#1565c0', fontSize: 13 }}>
                              {added[shortKey] ? <MdCheck /> : <MdPlaylistAdd />}
                            </IconButton>
                          </span>
                        </Tooltip>
                        <Tooltip title={added[longKey] ? 'Added' : 'Long Term'}>
                          <span>
                            <IconButton size="small" disabled={!!added[longKey]}
                              onClick={() => handleAdd(r.symbol, 'long_term')}
                              sx={{ p: '2px', bgcolor: added[longKey] ? '#e8f5e9' : '#fff3e0',
                                color: added[longKey] ? '#2e7d32' : '#e65100', fontSize: 13 }}>
