/** Shared ST trade-level normalization — keep in sync with web `src/utils/normalizeTradeLevels.js`. */
...
/**
 * Clamp/repair SL and targets so ST watchlist levels match web ShortTermPage.
